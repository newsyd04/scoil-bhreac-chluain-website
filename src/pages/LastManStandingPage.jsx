...
const GOOGLE_FORM_URL =
  "https://docs.google.com/forms/d/e/1FAIpQLSeSe2d11R1D9cL4oi-VzWrhdUt_8n7yBai-l6-PpRMQbdNkyw/viewform?usp=header"; // <-- replace
const ALADDIN_PAYMENT_URL = "https://www.aladdin.ie/p/5552535895015424";

// Toggle this:
// true  => embed the form in-page
// false => show a button linking to the form
const EMBED_GOOGLE_FORM = true;
...
const LastManStanding = () => {
  ...
  const embedUrl = toGoogleEmbedUrl(GOOGLE_FORM_URL);
        ...
        <section className="space-y-6">
          ...
          <article id="enter" className="bg-white p-6 rounded-lg shadow">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
              <h2 className="text-2xl font-bold text-gray-900">Enter</h2>
              {!EMBED_GOOGLE_FORM && (
                <a
                  href={GOOGLE_FORM_URL}
                  target="_blank"
            ...
            {EMBED_GOOGLE_FORM ? (
              ...
              <p className="text-gray-700">
                Use the button above to open the Google Form in a new tab.
              </p>
            )}
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center justify-center px-4 py-2 rounded-md bg-white text-gray-900 font-semibold border border-gray-200 hover:bg-gray-50 transition"
              >
                Pay €10 (Aladdin)
              </a>
              <p className="text-sm text-gray-600 self-center">
                Payments are handled externally via Aladdin.
              </p>
            </div>
          </article>
          ...
          <article className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="space-y-4">
              {rounds.map((round) => (
                <div key={round.title} className="rounded-lg border border-gray-200">
                  <div className="flex items-center justify-between px-4 py-3 bg-[#F9F8F4] rounded-t-lg">
                    <div>
          ...
          <article className="bg-white p-6 rounded-lg shadow">
            <h2 className="text-2xl font-bold mb-2 text-gray-900">Prizes</h2>
            <p className="text-gray-700">
              <span className="font-semibold">€500 must be won</span>. If multiple entrants remain at the end,
              the winner is decided by accumulated <span className="font-semibold">‘scored for’</span> points
              from the teams they selected (or joint winners if tied).
            </p>
          </article>
        </section>

        <footer className="mt-12 text-center text-sm text-gray-600">
          Follow your progress on{" "}
          <a
            href="https://www.scoilbhreacchluain.ie/latest"
            target="_blank"
            rel="noreferrer"
